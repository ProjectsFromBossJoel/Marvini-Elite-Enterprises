  ...
  tr.innerHTML = `
    ...
    <td>
      <div class="row-actions">
        ...
        <button aria-label="${isPublished ? "Unpublish" : "Publish"}" data-action="toggle-publish" title="${isPublished ? "Unpublish" : "Publish"}" data-perm="edit">
        ...
        <button aria-label="Remove" title="Remove" class="danger" data-action="delete" data-confirm-remove data-perm="delete">
